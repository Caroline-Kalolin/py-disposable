...
CONNECTOR_OWNER = 'GSP_DA_POC'
CONNECTOR_NAME = 'Python_EC14_Connector'
CONNECTOR_VERSION = '1.0'

API_VERSION = 'v1.0'
API_VERSION_KEY = 'api_version'

# AUTH_URL = 'https://app-apagsptest.apa-gsp.tieto-og.cloud/rest/v1/auth/token' # do not have authorise url
TOKEN_URL = 'https://app-apagsptest.apa-gsp.tieto-og.cloud/rest/v1/auth/token'
REFRESH_URL = 'https://app-apagsptest.apa-gsp.tieto-og.cloud/rest/v1/auth/token'
REDIRECT_URL = 'https://app-apagsptest.apa-gsp.tieto-og.cloud'
EC_CONTRACT_URL_FORMAT = 'https://app-apagsptest.apa-gsp.tieto-og.cloud/rest/v1/domain/data/CONTRACT;OBJECT_ID=064673EE6D50523BE0630100007FD693'
TRUE = 'true'

def buildRestRequest(connector_runtime_settings: dict) -> str:
        return EC_CONTRACT_URL_FORMAT

def get_rest_client(secret_arn: str):
...
class SalesforceConfigurationHandler(ConfigurationHandler):
    ...
    def validate_credentials(self, request: requests.ValidateCredentialsRequest) -> \
        ...
        request_uri = buildRestRequest(request.connector_runtime_settings)
