...
class HttpsClient:
    ...
    def rest_get(self, request_uri: str) -> RestResponse:
        headers = self.authorization_header
        resp = self.https_client.request(method='GET',
                                         url=request_uri,
                                         headers=headers)
        return RestResponse(status_code=resp.status,
                                  response=resp.data.decode('utf-8'),
                                  error_reason=resp.reason)

    def rest_post(self, request_uri: str, post_data: str) -> RestResponse:
    ...
    def rest_patch(self, request_uri: str, patch_data: str) -> RestResponse:
        headers = {**self.authorization_header, 'Accept-Encoding': 'gzip', 'Content-Type': 'application/json'}
    ...
    def rest_put(self, request_uri: str, put_data: str) -> RestResponse:
    ...
    def rest_delete(self, request_uri: str) -> RestResponse:
